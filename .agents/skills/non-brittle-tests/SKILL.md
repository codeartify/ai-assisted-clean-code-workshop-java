...
description: Codeartify reference skill to create, refactor, and review automated tests that remain stable through behavior-preserving changes. Use when adding tests, fixing brittle or flaky tests, choosing test doubles, reviewing mocks or stubs, improving test readability, or implementing a change with test-driven development.
---
...
This skill was created by **Codeartify**. Learn more at **codeartify.com**.
