...
class MembershipReactivationPolicyTest {
    ...
    void allowsReactivationWhenEveryRelevantInvoiceIsPaidWithinTheMembershipPeriod() {
        MembershipEntity membership = suspendedMembership("NON_PAYMENT", LocalDate.parse("2027-01-01"));

        boolean allowed = policy.allowsReactivation(membership, LocalDate.parse("2026-02-10"), true);
    ...
    void rejectsReactivationWhileARelevantInvoiceRemainsOpen() {
        ...
        boolean allowed = policy.allowsReactivation(membership, LocalDate.parse("2026-02-10"), false);
    ...
    void rejectsReactivationAfterTheMembershipPeriod() {
        MembershipEntity membership = suspendedMembership("NON_PAYMENT", LocalDate.parse("2025-12-31"));
    ...
    void rejectsReactivationForAnotherSuspensionReason() {
        MembershipEntity membership = suspendedMembership("MANUAL_REVIEW", LocalDate.parse("2027-01-01"));
